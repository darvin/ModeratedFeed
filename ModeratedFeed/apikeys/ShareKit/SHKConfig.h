...
#define SHKMyAppName			@"ModeratedFeed"
#define SHKMyAppURL				@"http://moderatedfeed.appspot.com"
...
#define SHKReadItLaterKey			@"eWog5WKXpK768ao4a5T93a8T4fAfi6e4"
 ...
 */
#define SHKTwitterConsumerKey		@"CwoANAEr5qjX7wEW58xXTw"
#define SHKTwitterSecret			@"4l3QLI3jI4QSZKG68evdnCC2FvlSJ2ItgbomplA"
#define SHKTwitterCallbackUrl		@"http://moderatedfeed.appspot.com/callback" // You need to set this if using OAuth, see note above (xAuth users can skip it)
#define SHKTwitterUseXAuth			0 // To use xAuth, set to 1
#define SHKTwitterUsername			@"sergey_v_klimov" // Enter your app's twitter account if you'd like to ask the user to follow it when logging in. (Only for xAuth)
...
#define SHKBitLyLogin				@"o_6o9euvemj4"
#define SHKBitLyKey					@"R_123c0acb241208643e820e86bc08a8cd"
...
#define SHKFlickrConsumerKey @"9385d247315ee7ad1789613354d6221a"	// The consumer key
#define SHKFlickrSecretKey @"cb2dd02c06a72032"		// The secret key
#define SHKFlickrCallbackUrl @"app://flickr"	// The user defined callback url


// LinkedIn - https://developer.linkedin.com/documents/authentication
#define SHKLinkedInConsumerKey		@"5emfuv6z78e8"
#define SHKLinkedInSecret			@"9x2jHNPxJWTUif2J"
#define SHKLinkedInCallbackUrl		@"http://moderatedfeed.appspot.com/callback"

// Foursquare V2 - https://developer.foursquare.com
#define SHKFoursquareV2ClientId @"YW0LASY33SSDJI3ZZVM23SAAMRSZU0U3134GZKZW5IMYIIUJ"
#define SHKFoursquareV2RedirectURI @"J15O4GJ4RYCTYW0ZY5GEMMZTCB44V0S0T0YKLUBHADYCNHU0"
